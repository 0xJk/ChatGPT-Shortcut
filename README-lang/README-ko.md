...
Aibot 프롬프트의 출처는 인터넷 선택, 커뮤니티 공유, 그리고 [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts)를 포함합니다. 우리는 규칙적으로 새로운 프롬프트와 영감을 제공하기 위해 업데이트할 것입니다. Aibot 를 사용하는 방법에 대해 알아보려면, [사용자 매뉴얼](https://www.aibot.top/ko/docs/guides/getting-started)을 참조하십시오.
